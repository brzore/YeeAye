...
<html>
	<head>
		...
		$.include(['<%=basePath %>resource/css/desktop.css', 
		           '<%=basePath %>resource/css/jquery-ui-1.9.2.custom.min.css',
		           '<%=basePath %>resource/css/smartMenu.css' ,
		           '<%=basePath %>resource/js/jquery-ui-1.9.2.custom.min.js',
	...
	<body>
		...
		<div id="lr_bar">
			...
			<div id="start_block">
				...
				<div id="start_item">
					<ul class="item admin">
						<li><span class="adminImg"></span> Brzore</li>
					</ul>
					<ul class="item">
